...
if MAXKNEEXT=. then MAXKNEEXT=MAXKNEEXTY4Y6;
end; 

drop VITAL48M IADLSHOPY6 IADLMEALY6 IADLHVHOUSWKY6 BMDHIPDXAY6 CHAIRTIMEY4Y6 GTSPEED6MY4Y6 MAXGRIPY4Y6 MAXKNEEXTY4Y6;
run;
